...
Градиент применяется к заголовку на главной странице и фону логотипа. Кнопки и остальные интерактивные элементы используют `color[0]` с осветлением на hover/active.
