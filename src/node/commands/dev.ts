...
export async function dev(root?: string, port?: number) {
  ...
  writeVitePressConfig(docsDir, result.config, {
    ...
    changelogSources: result.changelogSources,
    changelogTabs: result.changelogTabs,
      ...
      debounceTimer = setTimeout(async () => {
        try {
          ...
          writeVitePressConfig(newDocsDir, newResult.config, {
            ...
            changelogSources: newResult.changelogSources,
            changelogTabs: newResult.changelogTabs,
